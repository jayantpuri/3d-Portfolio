...
const Contacts = () => {
  ...
  return (
    <section className="w-full min-h-screen relative my-20 c-space flex flex-col justify-center items-center">
      <img
        src={"./assets/terminal.png"}
        alt="terminal"
        className="absolute inset-0 min-h-screen w-full sm:w-[85%] xl:w-[0%] mx-auto"
      />
      <div className="contact-container">
        <p className="head-text">Let&apos;s Talk</p>
        <p className="text-xl text-white-600">
          Wether you are looking to build a new project, or improve an existing
